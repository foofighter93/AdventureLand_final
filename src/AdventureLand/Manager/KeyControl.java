...
public class KeyControl {
	...
	public static int UP2 = 8;
	public static int LEFT2 = 9;
	public static int DOWN2 = 10;
	public static int RIGHT2 = 11;
	public static int SHOOT2 = 12;
	...
	public static void keySet(int i, boolean b) {
		...
		else if(i == KeyEvent.VK_J) keyState[SHOOT2] = b;
		else if(i == KeyEvent.VK_T) keyState[TRANSFER] = b;
	}
